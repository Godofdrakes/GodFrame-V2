...
bool TextureApp::BuildShaders( const char* pathToVertexShader, const char* pathToFragmentShader ) {
    using namespace std;
...
unsigned int TextureApp::LoadShader( const char* pathToShader, unsigned int shaderType ) {
    using namespace std;
